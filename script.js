...
var resumeString = "<img src='images/resumeThumbnail.png' class='resumeThumbnail'><div class='downloadSpace'><div class='pdfname'><img src='images/pdf.png'><label>Vinayak Resume.pdf</label></div><a href='assets/Bot&#39;s Resume.pdf' download='Vinayak_Patil_Resume.pdf'><img class='download' src='images/downloadIcon.svg'></a></div>";
...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Hi kak 👋🏻,<br><br>Saat ini <span class='bold'><a class='alink'>hobi.my.id</a>Sedang Maintenance.</span><br><br>Harap bersabar ya kak atau dapat menghubungi kami di <span class='bold'>cs@hobi.my.id</span><br><br>Terima Kasih.<br><br>Ketik <span class='bold'>'help'</span> untuk perintah berikutnya.<br>");
            }, 2000);
            break;
        case "help":
